...
\fancypagestyle{plain}{
	...
	\fancyhead[R]{\ifthenelse{\isodd{\value{page}}}{\includegraphics[height = 1cm]{header/hsrlogo.png}}
								{\includegraphics[height = 1cm]{images/HSR.jpg}}} %Kopfzeile links
	\fancyhead[C]{\textsl{\rightmark}} %zentrierte Kopfzeile
	\fancyhead[L]{\ifthenelse{\isodd{\value{page}}}{\includegraphics[height = 1cm]{images/HSR.jpg}}
