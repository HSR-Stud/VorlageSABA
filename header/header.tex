...
\fancypagestyle{plain}{
	...
	\fancyhead[R]{\ifthenelse{\isodd{\value{page}}}{\includegraphics[width = 3.5cm]{header/hsrlogo}}{}} %Kopfzeile links
	\fancyhead[C]{\textsl{\rightmark}} %zentrierte Kopfzeile
	\fancyhead[L]{\ifthenelse{\isodd{\value{page}}}{}{\includegraphics[width = 3.5cm]{header/hsrlogo}}} %Kopfzeile rechts
