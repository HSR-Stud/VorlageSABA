...
\fancypagestyle{plain}{
	...
	\fancyhead[R]{\ifthenelse{\isodd{\value{page}}}{\includegraphics[height = 1cm]{header/hsrlogo}}
								{\includegraphics[height = 1cm]{images/HSR}}} %Kopfzeile links
	\fancyhead[C]{\textsl{\rightmark}} %zentrierte Kopfzeile
	\fancyhead[L]{\ifthenelse{\isodd{\value{page}}}{\includegraphics[height = 1cm]{images/HSR}}
								{\includegraphics[height = 1cm]{header/hsrlogo}}} %Kopfzeile rechts
