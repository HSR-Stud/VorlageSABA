...
\fancypagestyle{plain}{
	...
	\fancyhead[L]{\includegraphics[width = 3.5cm]{header/hsrlogo}} %Kopfzeile links
	\fancyhead[C]{\textsl{\rightmark}} %zentrierte Kopfzeile
	%\fancyhead[R]{\includegraphics[width = 2.5cm]{header/axpologo}\vspace*{-0.25cm}} %Kopfzeile rechts
	\fancyhead[R]{ } %Kopfzeile
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{titlesec}
\titlespacing{\section}{-\marginparwidth}{0pt}{0.2em}
\titlespacing{\subsection}{-\marginparwidth+10pt}{0pt}{0.2em}
\titlespacing{\subsubsection}{-\marginparwidth+14pt}{0.2em}{0.2em}
\titlespacing{\paragraph}{-\marginparwidth+18pt}{0.2em}{0.2em}
